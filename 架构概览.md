...
目标代码目录：`D:\大模型论文复现\YUV_Reversible_Attack_2025`  
当前主线依据：`D:\大模型论文复现\最后确认文件.md`
...
```text
YUV_Reversible_Attack_2025\ORI_IMG
```
...
```text
YUV_Reversible_Attack_2025\output\rae
```
...
- 当前项目不是 Rt-LRM/LCO 方向，旧目录 `Rt-LRM-main` 只作为历史材料保留。
- README 较简略，复现流程需要依赖本地文档补齐。
